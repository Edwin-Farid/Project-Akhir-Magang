        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    ...
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">Absensi</span>
                </a>
                <a href="javascript:;"
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="nav-item">
                    <ul>
                        ...
                        <li class="nav-item">
                            <a href="/reservation" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Pemesanan</span>
                                </div>
                            </a>
                        </li>
                    </ul>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'pengguna' }"
                        @click="activeDropdown === 'pengguna' ? activeDropdown = null : activeDropdown = 'pengguna'">
                        <div class="flex items-center">
                        ...
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'pengguna' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'pengguna'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/pengguna/tabs">Pengguna</a>
                        </li>
                        <li>
                            <a href="/pengguna/accordions">Pegawai</a>
                        </li>
                    </ul>
                </li>
            </ul>
